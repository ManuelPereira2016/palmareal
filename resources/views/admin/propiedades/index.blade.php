    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border fillable">
                ...
                <a href="#rated-properties" data-toggle="modal" class="btn btn-warning">Destacadas</a>
            </div>
            <div class="box-body">
...
<div class="modal fade" id="rated-properties" tabindex="-1" role="dialog" >
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="change-image">Propiedades Destacadas seleccionadas</h4>
            </div>
            <div class="modal-body">      
                <div class="box box-info">
                    <div class="box-body chat" >
                        <table class="table">
                            @foreach ($rated_properties as $element)
                            <tr>
                                <td>{{ $element -> property -> name }}</td>
                                <td width="18">
                                    <form action="{{ route('best_properties_destroy', $element -> id) }}" method="post" onsubmit="return confirm('¿Esta Propiedad ya no aparecera entre las destacadas, esta seguro?');">
                                        {{ csrf_field() }}
                                        <input type="hidden" name="_method" value="delete">
                                        <button type="submit" class="btn btn-danger btn-xs"><i class="fa fa-remove"></i></button>
                                    </form>
